...
parser.add_argument('--image_data_dir', type=str, default='drive/tensorflow-deeplab-v3-plus/dataset/Images',
                    help='The directory containing the image data.')

parser.add_argument('--label_data_dir', type=str, default='drive/tensorflow-deeplab-v3-plus/dataset/Labels',
                    help='The directory containing the ground truth label data.')

parser.add_argument('--evaluation_data_list', type=str, default='drive/tensorflow-deeplab-v3-plus/dataset/val.txt',
