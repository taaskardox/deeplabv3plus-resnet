...
parser.add_argument('--model_dir', type=str, default='drive/tensorflow-deeplab-v3-plus/model',
...
parser.add_argument('--data_dir', type=str, default='drive/tensorflow-deeplab-v3-plus/dataset/',
...
parser.add_argument('--pre_trained_model', type=str, default='drive/tensorflow-deeplab-v3-plus/ini_checkpoints/resnet_v2_101/resnet_v2_101.ckpt',
...
def get_filenames(is_training, data_dir):
  ...
  """
  if is_training:
    return [os.path.join(data_dir, 'data_train.record')]
  else:
    return [os.path.join(data_dir, 'data_val.record')]
