...
parser.add_argument('--label_data_dir', type=str, default='Labes',
...
def main(unused_argv):
  ...
  train_output_path = os.path.join(FLAGS.output_path, 'data_train.record')
  val_output_path = os.path.join(FLAGS.output_path, 'data_val.record')
